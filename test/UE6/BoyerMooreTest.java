...
public class BoyerMooreTest {
	...
	public void search() {
		...
		final Result actual = BoyerMoore.search(NEEDLE_ASSIGNMENT, HAYSTACK_ASSIGNMENT);
	...
	public void searchSelf() {
		...
		final Result actual = BoyerMoore.search(NEEDLE_ASSIGNMENT, NEEDLE_ASSIGNMENT);
		assertEquals(expected.count, actual.count, "Number of matches differed");
		assertArrayEquals(expected.resultIndices, actual.resultIndices, "Match indices differed");
	}
	...
	public void searchLoremIpsum() {
		...
		final Result actual = BoyerMoore.search(NEEDLE_LOREM_IPSUM, HAYSTACK_LOREM_IPSUM);
		assertEquals(expected.count, actual.count, "Number of matches differed");
		assertArrayEquals(expected.resultIndices, actual.resultIndices, "Match indices differed");
	}
	...
	public void searchFaust() {
		...
		final Result actual = BoyerMoore.search(NEEDLE_FAUST, HAYSTACK_FAUST);
		assertEquals(expected.count, actual.count, "Number of matches differed");
		assertArrayEquals(expected.resultIndices, actual.resultIndices, "Match indices differed");
	}
	...
	public void searchNullText() {
		assertThrows(IllegalArgumentException.class, () -> BoyerMoore.search(NEEDLE_ASSIGNMENT, null),
				"IllegalArgumentException must be thrown on null haystack");
	}

	@Test
	public void searchNullPattern() {
		assertThrows(IllegalArgumentException.class, () -> BoyerMoore.search(null, HAYSTACK_ASSIGNMENT),
				"IllegalArgumentException must be thrown on null needle");
	}

	@Test
	public void searchEmptyPattern() {
		assertThrows(IllegalArgumentException.class, () -> BoyerMoore.search("", HAYSTACK_ASSIGNMENT),
